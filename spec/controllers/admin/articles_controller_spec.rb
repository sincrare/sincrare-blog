...
RSpec.describe Admin::ArticlesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested admin_article as @admin_article" do
      ...
      expect(assigns(:admin_article)).to eq(article)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new admin_article as @admin_article" do
      ...
      expect(assigns(:admin_article)).to be_a_new(Article)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created admin_article as @admin_article" do
        post :create, params: {admin_article: valid_attributes}, session: valid_session
        expect(assigns(:admin_article)).to be_a(Article)
        expect(assigns(:admin_article)).to be_persisted
      end
